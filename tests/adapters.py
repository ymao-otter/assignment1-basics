...
def run_multihead_self_attention(
    ...
    """
    from transformer.model import MultiheadSelfAttention
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    from transformer.model import MultiheadSelfAttention, RoPE

    rope = RoPE(theta, d_model // num_heads, max_seq_len)
    multihead_self_attention = MultiheadSelfAttention(
        d_model, num_heads, rope=rope, token_positions=token_positions
    )
    multihead_self_attention.load_state_dict(
        {
            "q_proj.weight": q_proj_weight,
...
def run_transformer_block(
    ...
    """
    from transformer.model import TransformerBlock, RoPE
...
def run_transformer_lm(
    ...
    transformer_lm = TransformerLM(
        vocab_size, d_model, num_layers, num_heads, d_ff, rope_theta, context_length
    )
...
def run_get_lr_cosine_schedule(
    ...
    """
    from transformer.optimizer import get_learning_rate
...
def run_save_checkpoint(
    ...
    """
    from transformer.serialization import save_checkpoint
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from bpe.bpe_training import run_train_bpe
